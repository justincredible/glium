...
pub enum ProgramCreationInput<'a> {
    ...
    SourceCode {
        ...
        /// Affirms the fragment shader correctly outputs colors in `sRGB` or `RGB`. This is true by default,
        /// meaning that the program is responsible for outputting correct `sRGB`.
        ///
